...
import carImage from "../assets/backiee-310041-landscape.jpg";

// function Card(props) {
function Card({btnText,aboutCar="Super Car"}){
    ...
    return ( 
        <div className="md:max-w-sm w-full p-6 rounded-xl shadow-xl bg-black border-zinc-800 hover:border-white transition-all duration-300 hover:transform hover:scale-105 group">
      ...
      <div className="mb-4">
        ...
        <h2 className="text-xl font-bold text-white mb-2 group-hover:text-gray-300 transition-colors duration-200">
          {aboutCar}
          {/* {aboutCar || "SUPER CAR"} */}
          {/* we are using || here because if aboutCar value is not there and use defaul value which is SUPER CAR -- BUT DONT GIVE DEFAULT VALUE HERE JUST GIVE WHILE INITIALISING IT IN PROPS*/}
        </h2>
      </div>
